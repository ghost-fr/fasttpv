...
public class InventoryWindowViewModel : ViewModelBase
{
    ...
    private async Task LoadCategoryOptionsAsync()
    {
        try
        {
            var names = await AppRuntime.Categories.GetActiveNamesAsync();
